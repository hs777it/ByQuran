...
class AuthController extends GetxController {
  ...
  void googleSignUp() async {
    ...
    if (googleAccount != null) {
      ...
      var displayName = googleSignIn.currentUser!.displayName;
      var photoUrl = googleSignIn.currentUser!.photoUrl;
      final accountData = GetStorage();
      accountData.write('email', email);
      accountData.write('displayName', displayName);
      accountData.write('photoUrl', photoUrl);
    }
  }
